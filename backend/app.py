...
from google.gmaps import place_radius_search, place_name_search, place_arbitrary_search
from userip.geo import user_location
...
template_position = join(dirname(dirname(__file__)),"frontend/templates")

app = Flask(__name__, template_folder=template_position)
